                ...
                <table class="table datatable-button-html5-columns">
                    ...
                    @foreach($students as $s)
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    <a href="#" class=" btn btn-danger" data-toggle="dropdown"> Print Invoice <i class="icon-arrow-down5"></i>
                                    </a>
                            <div class="dropdown-menu dropdown-menu-left">
                                <a href="{{ route('payments.invoice_print', [Qs::hash($s->user_id)]) }}" class="dropdown-item">All Invoice</a>
